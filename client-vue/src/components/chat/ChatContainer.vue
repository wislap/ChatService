...
console.warn('DEPRECATED: ChatContainer component is retained for compatibility but deprecated. Prefer using the Announcement view and new chat modules.')
import MessageBubble from './MessageBubble.vue'
import type { ExtendedMessageData } from './types'
...
/* types imported from ./types (ExtendedMessageData) */
